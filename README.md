...
as a result seed classification in critical for both marketing and production in order to ensure that agricaltural system are viable in this report we used dry bean dataset(https://archive.ics.uci.edu/dataset/602/dry+bean+dataset) that has measurement of 13611 bean sampeles to classify dry beans using three machine learning techiques the dataset has 7 different.
